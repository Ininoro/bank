...
<div class="two_sides">
    ...
    <div class="left">
    <h1 class='left_h1'>Потребительский кредит</h1>
    <h5 class="left_h5">
...
Кредит выдается наличными или переводится на выбранную банковскую карту.
 ...
 <img target="_blank" href="./calc/calc.html" src="./img/calc.png" style="cursor: pointer;"> Рассчитать потребительский кредит
        </a>
            </div>
            </div>
