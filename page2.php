...
<div class="two_sides">
    ...
    <div class="left">
    <h1 class='left_h1'>Кредит для бизнеса</h1>
    <h5 class="left_h5">
        Покупайте помещения для бизнеса или сдачи в аренду до 60 млн ₽
    </h5>
 ...
 <img target="_blank" href="./calc/calc.html" src="./img/calc.png" style="cursor: pointer;"> Рассчитать кредит для бизнеса
        </a>
            </div>
            </div>
        ...
        <div class="benef-block">
            <div class="benef">
            <h1 class='benef_h1'>2 минуты</h1>
            <h2 class='benef_h2'>одобрение онлайн</h2>
            </div>
            <div class="benef">
            <h1 class='benef_h1'>7 лет</h1>
            <h2 class='benef_h2'>максимальный срок</h2>
            </div>
            <div class="benef">
            <h1 class='benef_h1'>40 млн ₽</h1>
			...
			<div class="row">
				<div class="col-md-6 mx-auto">
					<div class="card card-body text-center mt-5">
						<div class="heading display-5 pb-3">Кредитный калькулятор</div>
						<form id="loan-form">
